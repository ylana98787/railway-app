...
function HomePage() {
  ...
  // ФУНКЦІЯ ДЛЯ ОБРОБКИ ВИБОРУ ПОТЯГА (ВИКЛИКАЄТЬСЯ ПРИ КЛІКУ НА КАРТКУ)
  // train - об'єкт з даними вибраного потяга
  const handleSelectTrain = (train) => {
    
    // ПОКАЗУЄМО СПЛИВАЮЧЕ ВІКНО З ІНФОРМАЦІЄЮ ПРО ВИБРАНИЙ ПОТЯГ
    // alert() - вбудована функція для показу повідомлення
    // \n - символ нового рядка (переносить текст на наступний рядок)
    // ${train.number} - вставляє номер потяга
    // ${train.route} - вставляє маршрут
    // ${train.price} - вставляє ціну
